...
#ifndef TTCPAY_SWIFT_H
#define TTCPAY_SWIFT_H
...
@property (nonatomic) enum TTCPayType payType;
...
typedef SWIFT_ENUM(int32_t, TTCPayType, closed) {
  TTCPayTypeTTC = 0,
  TTCPayTypeACN = 1,
};
