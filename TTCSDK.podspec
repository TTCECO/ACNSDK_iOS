#
#  Be sure to run `pod spec lint TTCSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "chenchao"
  # s.authors            = { "chenchao" => "chenchao@tataufo.com" }
  # s.social_media_url   = "http://twitter.com/chenchao"
  ...
  # s.public_header_files = "TTCSDK/TTCSDK.h"
